...
pub(crate) static CONTROLLER_OPERATOR_RPC_BEFORE_RENEW: &[(&str, &str)] = &[
    ...
    ("UpdateVm", "vm-admin"),
    ("DeleteVm", "vm-admin"),
    ("SetVmDesiredState", "vm-admin"),
    ("GetVm", "read-only"),
    ("ListVms", "read-only"),
    ("AttachVmConsole", "vm-admin"),
    ("CreateWorkload", "vm-admin"),
    ("DeleteWorkload", "vm-admin"),
    ("SetWorkloadDesiredState", "vm-admin"),
    ("GetWorkload", "read-only"),
    ("ListWorkloads", "read-only"),
    ("CreateNetwork", "vm-admin"),
    ("DeleteNetwork", "vm-admin"),
    ("ListNetworks", "read-only"),
    ("CreateSecurityGroup", "vm-admin"),
    ("GetSecurityGroup", "read-only"),
    ("ListSecurityGroups", "read-only"),
    ("DeleteSecurityGroup", "vm-admin"),
    ("AttachSecurityGroup", "vm-admin"),
    ("DetachSecurityGroup", "vm-admin"),
    ("ListNodes", "read-only"),
    ("GetNode", "read-only"),
    ("CreateSshKey", "vm-admin"),
    ("DeleteSshKey", "vm-admin"),
